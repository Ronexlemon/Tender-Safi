...
function writeTenderDetails(string calldata _companyName,string calldata _tenderDescription,string calldata _deadlineDate,string calldata _contactEmail,uint _tenderAmount)public{
...
function readTenderDetails()public view returns(TenderDetails[] memory props){
