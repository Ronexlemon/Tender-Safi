import explore from "./ExploreBackground.svg";
...
const Explore = () => {
  return (
    <div
      ...
      className="max-w-[screen] w-[100%] min-h-[700px] h-[100%] bg-no-repeat bg-contain bg-slate-100 grid content-center justify-items-center"
    >
